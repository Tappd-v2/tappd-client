   ...
   <section class="mx-auto w-9/12">
      ...
      >
         <NuxtLink
            ...
            class="block w-full rounded bg-blue-500 px-5 py-5 text-center text-white transition-all duration-200 hover:scale-105 hover:shadow-md"
         >
            Bestel Online
         </NuxtLink>
         ...
         <NuxtLink
            ...
            class="block w-full rounded bg-gray-200 px-5 py-5 text-center transition-all duration-200 hover:scale-105 hover:shadow-md"
         >
            Roep personeel
         </NuxtLink>
      </div>
